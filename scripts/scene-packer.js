(() => {
  ...
  let adventureName = 'Expanse NPC Pack';
  let moduleName = 'expanse-npc-pack';
   ...
   *   const creaturePacks = [];
   */
  const creaturePacks = [`${moduleName}.npcs`];
  /**
   ...
   *   const journalPacks = [];
   */
  const journalPacks = [`${moduleName}.npc-notes`, `${moduleName}.ship-notes`];
  /**
